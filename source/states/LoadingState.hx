...
class LoadingState extends MusicBeatState
{
	...
	override function create()
	{
		...
		funkay = new FlxSprite(0, 0).loadGraphic(Paths.image('menus/loading_screen/funkay'));
	...
	override function update(elapsed:Float)
	{
		...
		if(!spawnedPessy)
		{
			...
			if(pressedTimes >= 5)
			{
				...
				pessy.frames = Paths.getSparrowAtlas('menus/loading_screen/pessy');
	...
	public static function prepareToSong()
	{
		...
		Thread.create(() -> {
			...
			if(Paths.fileExists('images/game/noteSkins/pixel/$customSkin.png', IMAGE)) noteSkin = customSkin;
