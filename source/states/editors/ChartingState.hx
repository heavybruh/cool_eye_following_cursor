...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create()
	{
		...
		vortexIndicator = new FlxSprite(gridBg.x - GRID_SIZE, FlxG.height/2).loadGraphic(Paths.image('menus/_editors/vortex_indicator'));
		...
		{
			eventIcon = new FlxSprite(0, iconY).loadGraphic(Paths.image('menus/_editors/eventIcon'));
		...
		autoSaveIcon = new FlxSprite(50).loadGraphic(Paths.image('menus/_editors/autosave'));
	...
	override function update(elapsed:Float)
	{
		...
		{
			grid.velocity.x = (Conductor.bpm / 2);
	...
	function addDataTab()
	{
		...
		noteTextureInputText.unfocus = function()
		{
			...
			if(changed)
			{
				var textureLoad:String = 'images/game/noteSkins/${noteTextureInputText.text}.png';
