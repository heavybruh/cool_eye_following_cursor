...
class WeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	function reloadBG() {
		...
		if(assetName != null && assetName.length > 0) {
			if( #if MODS_ALLOWED FileSystem.exists(Paths.modsImages('menus/story_menu/backgrounds/menu_' + assetName)) || #end
			Assets.exists(Paths.getPath('images/menus/story_menu/backgrounds/menu_' + assetName + '.png', IMAGE), IMAGE)) {
